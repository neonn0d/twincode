...
`,
	...
	// ─── Buddy / companion (deleted in twin) ──────────────────────

	'buddy/useBuddyNotification': `
export function findBuddyTriggerPositions() { return []; }
export function useBuddyNotification() {}
`,

	'buddy/feature': `
export function isBuddyEnabled() { return false; }
export function getBuddyConfig() { return {}; }
`,

	'buddy/companion': `
export function getCompanion() { return null; }
export function createCompanion() { return null; }
`,

	'buddy/CompanionSprite': `
export function CompanionSprite() { return null; }
export default function() { return null; }
`,

	'buddy/observer': `
export function createBuddyObserver() { return { observe: () => {}, disconnect: () => {} }; }
`,

	'buddy/prompt': `
export function getBuddyPrompt() { return ''; }
`,
