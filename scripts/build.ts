...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@neonn0d/twin'),
...
`,
        ...
        // Resolve native addon, missing snapshot, and removed cloud SDK imports to stubs
        for (const mod of [
          'audio-capture-napi',
          'audio-capture.node',
          ...
          'code-excerpt',
          'stack-utils',
          // Cloud SDKs removed in twin — inlined as stubs
          'google-auth-library',
          '@aws-sdk/client-sts',
          ...
          '@azure/identity',
          // OpenTelemetry — inlined as stubs (packages removed in twin)
          '@opentelemetry/api',
        ...
        // Buddy modules were deleted — intercept relative imports by path pattern
        build.onResolve({ filter: /[/\\]buddy[/\\]/ }, () => ({
          path: 'buddy-stub',
          namespace: 'native-stub',
        }))
...
// Buddy exports (src/buddy/ deleted in twin)
export const findBuddyTriggerPositions = () => [];
export const useBuddyNotification = noop;
export const isBuddyEnabled = () => false;
export const CompanionSprite = noop;
export const CompanionFloatingBubble = noop;
export const companionIntroText = '';
export const companionReservedColumns = () => 0;
export const companionUserId = () => null;
export const fireCompanionObserver = noop;
export const getCompanion = () => null;
export const getCompanionIntroAttachment = () => null;
export const MIN_COLS_FOR_FULL_SPRITE = 999;
export const rollWithSeed = () => null;
export const StoredCompanion = null;
