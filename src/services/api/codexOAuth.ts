...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to twin now.</p>
    <p>twin will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in twin.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in twin.</p>
  </body>
</html>`
}
