...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to localcode now.</p>
    <p>localcode will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in localcode.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in localcode.</p>
  </body>
</html>`
}
