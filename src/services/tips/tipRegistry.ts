...
const externalTips: Tip[] = [
  {
    id: 'new-user-warmup',
    content: async () =>
      `Start with small features or bug fixes, tell localcode to propose a plan, and verify its suggested edits`,
    cooldownSessions: 3,
    async isRelevant() {
  ...
  },
  {
    id: 'git-worktrees',
    content: async () =>
      'Use git worktrees to run multiple twin sessions in parallel.',
    cooldownSessions: 10,
    isRelevant: async () => {
      try {
        const config = getGlobalConfig()
  ...
  },
  {
    ...
    content: async () =>
      'Running multiple twin sessions? Use /color and /rename to tell them apart at a glance.',
    cooldownSessions: 10,
    isRelevant: async () => {
  ...
  {
    id: 'memory-command',
    content: async () => 'Use /memory to view and manage localcode memory',
    cooldownSessions: 15,
    async isRelevant() {
      const config = getGlobalConfig()
  ...
  },
  {
    ...
    content: async () => 'Connect localcode to your IDE · /ide',
    cooldownSessions: 4,
    async isRelevant() {
  ...
  },
  {
    ...
    content: async () =>
      'Run /install-github-app to enable GitHub issue and PR tagging from localcode',
    cooldownSessions: 10,
    isRelevant: async () => !getGlobalConfig().githubActionSetupCount,
  },
  {
    id: 'install-slack-app',
    content: async () => 'Run /install-slack-app to use localcode in Slack',
    cooldownSessions: 10,
  ...
  },
  {
    id: 'paste-images-mac',
    content: async () =>
      'Paste images into localcode using control+v (not cmd+v!)',
    cooldownSessions: 10,
  ...
  },
  {
    id: 'continue',
    content: async () =>
      'Run twin --continue or twin --resume to resume a conversation',
    cooldownSessions: 10,
    isRelevant: async () => true,
  },
  {
  ...
  },
  {
    id: 'desktop-app',
    content: async () =>
      'Run localcode locally or remotely with /desktop',
    cooldownSessions: 15,
  ...
  },
  {
    ...
    content: async ctx => {
      ...
      return variant === 'copy_b'
        ? `Use ${cmd} for better one-shot answers. localcode thinks it through first.`
  ...
  },
  {
    ...
    content: async ctx => {
      ...
      return variant === 'copy_b'
        ? `For big tasks, tell localcode to ${blue('use subagents')}. They work in parallel and keep your main thread clean.`
        : `Say ${blue('"fan out subagents"')} and localcode sends a team. Each one digs deep so nothing gets missed.`
    },
    cooldownSessions: 3,
    isRelevant: async () => {
      if (!is1PApiCustomer()) return false
  ...
  },
  {
    ...
    content: async ctx => {
      ...
      return reward
        ? `Share localcode and earn ${claude(formatCreditAmount(reward))} of extra usage · ${claude('/passes')}`
