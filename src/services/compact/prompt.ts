...
10. Session Note (3-5 lines, plain language — saved to project notes):
    ## What we did
    [One sentence per major thing completed]
    ## Blocked / broken
    [Any errors, blockers, or unresolved issues. "None" if clean.]
    ## What's next
    [The concrete next action, or "nothing" if session is wrapped up]
...
10. Session Note:
    ## What we did
    [One sentence per completed thing]
    ## Blocked / broken
    [Blockers or "None"]
    ## What's next
    [Next concrete action or "Nothing"]
