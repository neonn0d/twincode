...
const DEFAULT_PREFIX =
  `You are localcode, an open-source coding agent and CLI.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are localcode, an open-source coding agent and CLI running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are localcode, built on the Claude Agent SDK.`
