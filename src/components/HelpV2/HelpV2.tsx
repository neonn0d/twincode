...
export function HelpV2(t0) {
  ...
  let t6;
  if ($[31] !== tabs) {
    t6 = <Tabs title={false ? "/help" : `twin v${MACRO.VERSION}`} color="professionalBlue" defaultTab="general">{tabs}</Tabs>;
    $[31] = tabs;
    $[32] = t6;
  } else {
    t6 = $[32];
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginTop={1}><Text>For more help:{" "}<Link url="https://github.com/neonn0d/twin" /></Text></Box>;
    $[33] = t7;
  } else {
    t7 = $[33];
  }
