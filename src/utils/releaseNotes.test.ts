...
## [0.8.0](https://github.com/neonn0d/twin/compare/v0.7.0...v0.8.0) (2026-05-02)

### Features

* add thing

## [0.7.0](https://github.com/neonn0d/twin/compare/v0.6.0...v0.7.0) (2026-04-26)
...
test('getReleaseTagUrl normalizes build metadata to the public tag', () => {
  expect(getReleaseTagUrl('0.8.0+abc123')).toBe(
    'https://github.com/neonn0d/twin/releases/tag/v0.8.0',
  )
})
