...
export const DESCRIPTION = 'Get or set twin configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set twin configuration settings.

  View or change twin settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
