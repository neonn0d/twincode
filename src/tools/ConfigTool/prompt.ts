...
export const DESCRIPTION = 'Get or set localcode configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set localcode configuration settings.

  View or change localcode settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.localcode.json)
${globalSettings.join('\n')}
