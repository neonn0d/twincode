...
export const LogSessionTool = buildTool({
  ...
  get inputSchema(): LogSessionInputSchema {
    return logSessionInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
...
export const SaveKnowledgeTool = buildTool({
  ...
  get inputSchema(): SaveKnowledgeInputSchema {
    return saveKnowledgeInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
...
export const GetKnowledgeTool = buildTool({
  ...
  get inputSchema(): GetKnowledgeInputSchema {
    return getKnowledgeInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
  ...
  async call({ topic }) {
    ...
    const brain = brainDir(vault, cwd)
    if (!topic) {
      return { data: { result: listKnowledgeStr(vault, cwd) } }
    }
    const slug = slugify(topic)
    const p = path.join(brain, `${slug}.md`)
...
export const ListKnowledgeTool = buildTool({
  ...
  get inputSchema(): ListKnowledgeInputSchema {
    return listKnowledgeInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
...
export const GetProjectContextTool = buildTool({
  ...
  get inputSchema(): GetProjectContextInputSchema {
    return getProjectContextInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
...
export const SetProjectContextTool = buildTool({
  ...
  get inputSchema(): SetProjectContextInputSchema {
    return setProjectContextInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
...
export const SetNextStepsTool = buildTool({
  ...
  get inputSchema(): SetNextStepsInputSchema {
    return setNextStepsInputSchema()
  },
  get outputSchema() {
    return lazySchema(() => z.object({ result: z.string() }))()
  },
